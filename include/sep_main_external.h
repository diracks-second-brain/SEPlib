...
extern int doc(char*)  ;
extern void sep_add_doc_line (char* line);
...
extern int seperr( char *format, ... );
extern int sreed_window_new(const char*,int,int*,int*,int*,int*,int,void*);
extern int srite_window_new(const char*,int,int*,int*,int*,int*,int,void*);
extern int sreed_window(const char*,int*,int*,int*,int*,int*,int,void*);
extern int srite_window(const char*,int*,int*,int*,int*,int*,int,void*);
extern int sep_window (int,const char*,int*, int*,int*,int*,int*,int, void *);
...
extern long long sreed_big(const char*, void*,size_t);
extern long long srite_big(const char*, void*, size_t);
